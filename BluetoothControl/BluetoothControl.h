...
class BluetoothControl : public PluginHost::IPlugin
    ...
    public:
        ...
        public:
            ...
            uint32_t Pair(const IBluetooth::pairingcapabilities capabilities) override
            {
                ...
                if (SetState(PAIRING) == Core::ERROR_NONE) {
                    result = BluetoothControl::Connector().Pair(Address(), AddressType(), static_cast<Bluetooth::ManagementSocket::capabilities>(capabilities));
            ...
            uint32_t AbortPairing() override
            {
                ...
                if (SetState(PAIRING) != Core::ERROR_NONE) {
                    result = BluetoothControl::Connector().PairAbort(Address(), AddressType());
                    if (result != Core::ERROR_NONE) {
            ...
            uint32_t Unpair() override
            {
                ...
                if (SetState(UNPAIRING) == Core::ERROR_NONE) {
                    ...
                    result = BluetoothControl::Connector().Unpair(Address(), AddressType());
        ...
        private:
            ...
            {
                BluetoothControl::Connector().Control().UserPasskeyConfirmReply(Address(), AddressType(), confirm);
            }
            void ReplyPasskey(const uint32_t passkey)
            {
                BluetoothControl::Connector().Control().UserPasskeyReply(Address(), AddressType(), passkey);
            }
    ...
    public:
        ...
        private:
            ...
            {
                BluetoothControl::Connector().Control().UserPINCodeReply(Address(), AddressType(), pinCode);
            }
